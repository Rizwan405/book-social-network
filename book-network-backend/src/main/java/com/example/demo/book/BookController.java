...
public class BookController {
    ...
    @PostMapping()
    public ResponseEntity<Integer> saveBook(@Valid @RequestBody BookRequest request, Authentication currentUser){
        return ResponseEntity.ok(bookService.save(request,currentUser));
    }
    @GetMapping("/{book-id}")
    public ResponseEntity<BookResponse> getBook(@PathVariable("book-id") Integer id){
    ...
    public ResponseEntity<?>uploadBookCoverPicture(@PathVariable("book-id") Integer bookId, @RequestPart("file")MultipartFile file, Authentication currentUser){
        bookService.uploadCoverPicture(bookId,file,currentUser);
